...
def attr_clustering(dataset_name='mine', num_atrr_clusters=112, json_file='./gpt4.0_cluster_a_photo_of4.json'):
    print("hello")
...
def attr_aggregate(text_features, dataset_name='pascal_voc', num_classes=20, num_atrr_clusters=112, \
                   json_file='./attributes_text/descriptors_pascal_voc_gpt4.0_cluster_a_photo_of4.json',topK=0.9):
    ...
    #print(f"DEBUG: fg_text shape: {fg_text.shape}")
    #print(f"DEBUG: attr_features shape: {attr_features.shape}")
    # 原有代码
